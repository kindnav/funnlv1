...
class TestFundEndpoints:
    def test_get_my_fund_no_fund(self) -> None:
    ...
    def test_get_fund_deals_graceful(self) -> None:
    ...
    def test_create_fund_validation_no_name(self) -> None:
    ...
    def test_create_fund_returns_proper_error_on_db_failure(self) -> None:
    ...
    def test_join_fund_invalid_code(self) -> None:
    ...
    def test_join_fund_missing_code(self) -> None:
...
class TestNotificationsEndpoint:
    def test_get_notifications_graceful(self) -> None:
